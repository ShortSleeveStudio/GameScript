/**
 * Settings constants for UI components.
 *
 * Contains undo text, placeholder text, and other UI-related constants.
...
export const ACTORS_UNDO_NOTES = 'actor notes';
export const ACTORS_PLACEHOLDER_NAME = "Enter the actor's name";
export const ACTORS_PLACEHOLDER_NOTES = 'Developer notes go here...';
