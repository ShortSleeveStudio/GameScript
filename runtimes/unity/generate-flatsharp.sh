#!/bin/bash
# Generates FlatSharp serialization code and copies it to Unity.
# Uses the csharp project as a build host for FlatSharp's MSBuild integration.
set -e
...
echo "=== GameScript FlatSharp Generator ==="
...
echo ""
echo "=== Step 1: Building to generate FlatSharp code ==="
cd "$CSHARP_DIR"
...
echo ""
echo "=== Step 2: Post-processing for Unity compatibility ==="
...
# Step 3: Copy FlatSharp.Runtime.dll
echo ""
echo "=== Step 3: Copying FlatSharp.Runtime.dll ==="
