...
public struct BoolValue : IFlatbufferObject
{
  ...
  public static Offset<GameScript.BoolValue> CreateBoolValue(FlatBufferBuilder builder,
      bool value = false) {
  ...
  public static Offset<GameScript.BoolValue> EndBoolValue(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<GameScript.BoolValue>(o);
  }
  ...
  public static Offset<GameScript.BoolValue> Pack(FlatBufferBuilder builder, BoolValueT _o) {
    if (_o == null) return default(Offset<GameScript.BoolValue>);
