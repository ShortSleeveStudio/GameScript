...
<div
	...
	class="inline-grid w-full grid-cols-3 items-center
	bg-slate-300
	text-slate-950
	dark:bg-slate-700
	dark:text-slate-300
	"
>
	<span class="inline-grid grid-cols-1 items-center justify-self-start">
		<button
			type="button"
	...
	<span data-tauri-drag-region class="justify-self-center">GameScript</span>
